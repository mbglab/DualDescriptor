...
# The Numeric Dual Descriptor Vector class (P Matrix form) implemented with PyTorch
...
class NumDualDescriptorPM(nn.Module):
    ...
    """
    def __init__(self, vec_dim=2, rank=1, rank_op='avg', rank_mode='drop', mode='linear', user_step=None, device='cuda'):
        super().__init__()
...
if __name__=="__main__":
    ...
    print("="*50)
    dd.grad_train(seqs_vectors, t_list, max_iters=100, tol=1e-8, learning_rate=0.1, decay_rate=0.99, batch_size=1024)  
