...
# Hierarchical Numeric Dual Descriptor (Mixed Layer Types) implemented with PyTorch
# This class integrates Layer types from both HierDDrn and HierDDts, allowing alternating layer types.
