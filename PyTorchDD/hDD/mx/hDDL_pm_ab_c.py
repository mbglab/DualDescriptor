...
class HierDDLmxC(nn.Module):
    ...
    def __init__(self, charset, rank=1, rank_mode='drop', vec_dim=2, 
                 ...
                 linker_dims=[50], input_seq_len=100, use_residual_list=None, 
...
if __name__ == "__main__":
    ...
    print("Mixed AB/PM Architecture with Linker Matrices and Character Sequence Processing")
    print("="*70)
    ...
    rank = 2
    vec_dim = 8
    input_seq_len = 300  # Fixed input character sequence length
    ...
    print("\n" + "="*50)
    print("Gradient Descent Training (PM Char Layer with Linker)")
    print("="*50)
    ...
    gd_history_pm = model_pm.grad_train(
        ...
        print_every=5,
        batch_size=32,
        checkpoint_file='gdlmx_pm_checkpoint.pth',
    ...
    print("\n" + "="*50)
    print("Auto-Training Example with Linker")
    print("="*50)
    ...
    auto_history = model_pm.auto_train(
        ...
        auto_mode='gap',
        print_every=5,
        checkpoint_file='autolmx_checkpoint.pth',
    ...
    # Save model
    model_pm.save("hierddlmxc_model.pth")
    ...
    print("\n" + "="*70)
    print("HierDDLmxC Demonstration Completed")
    print("="*70)
