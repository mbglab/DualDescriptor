...
# Author: Bin-Guang Ma (assisted by DeepSeek); Date: 2025-10-10 ~ 2026-1-10
...
if __name__ == "__main__":
    ...
    # Save model
    model.save("hierddltsc_model.pth")
    
    # Load model
    loaded_model = HierDDLtsC.load("hierddltsc_model.pth", device=device)
