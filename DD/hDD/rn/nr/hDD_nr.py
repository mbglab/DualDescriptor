...
# The Hierarchical Numeric Dual Descriptor (Random AB matrix form) implemented with pure Python
...
if __name__ == "__main__":
    ...
    print("\nCreating Hierarchical HierDDrn with layer normalization and residual connections...")
    hdd = HierDDrn(
        input_dim=input_dim,
