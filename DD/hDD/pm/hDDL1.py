...
class LinkedHierarchicalDD:
    ...
    def __init__(self, input_dim=4, model_dims=[4], linker_dims=[4], input_seq_len=100):
    ...
    def grad_train(self, seqs, t_list, max_iters=100, tol=1e-8, 
        ...
        Supports learning M, P, and Linker matrices.
        """
        history = []
        D_prev = float('inf')
...
if __name__ == "__main__":
    ...
    linker_dims = [80, 60, 40]  # Sequence lengths for each layer
    ...
    print("\nInitializing LinkedHierarchicalDD model...")
...
##    lhdd.show()
    ...
    lhdd.save("linked_hierarchical_model.pkl")
